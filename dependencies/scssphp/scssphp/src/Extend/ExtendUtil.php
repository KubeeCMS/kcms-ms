...
final class ExtendUtil
{
    ...
    public static function unifyComplex(array $complexes) : ?array
    {
        ...
        $base = new ComplexSelector($leadingCombinator === null ? [] : [$leadingCombinator], [new ComplexSelectorComponent(new CompoundSelector($unifiedBase), $trailingCombinator === null ? [] : [$trailingCombinator])], $hasLineBreak);
    ...
    public static function weave(array $complexes, bool $forceLineBreak = \false) : array
    {
        if (\count($complexes) === 1) {
            ...
            return [new ComplexSelector($complex->getLeadingCombinators(), $complex->getComponents(), \true)];
        }
