...
class BigInteger implements \JsonSerializable
{
     ...
     */
    public function add(\phpseclib3\Math\BigInteger $y) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public function subtract(\phpseclib3\Math\BigInteger $y) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public function multiply(\phpseclib3\Math\BigInteger $x) : \phpseclib3\Math\BigInteger
    {
     ...
     * @return BigInteger[]
     */
    public function divide(\phpseclib3\Math\BigInteger $y) : array
    {
     ...
     */
    public function modInverse(\phpseclib3\Math\BigInteger $n) : \phpseclib3\Math\BigInteger
    {
     ...
     * @return BigInteger[]
     */
    public function extendedGCD(\phpseclib3\Math\BigInteger $n) : array
    {
     ...
     */
    public function gcd(\phpseclib3\Math\BigInteger $n) : \phpseclib3\Math\BigInteger
    {
     ...
     * Absolute value.
     */
    public function abs() : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public function powMod(\phpseclib3\Math\BigInteger $e, \phpseclib3\Math\BigInteger $n) : \phpseclib3\Math\BigInteger
    {
     ...
     * Performs modular exponentiation.
     */
    public function modPow(\phpseclib3\Math\BigInteger $e, \phpseclib3\Math\BigInteger $n) : \phpseclib3\Math\BigInteger
    {
     ...
     * @see self::equals()
     */
    public function compare(\phpseclib3\Math\BigInteger $y) : int
    {
     ...
     */
    public function equals(\phpseclib3\Math\BigInteger $x) : bool
    {
     ...
     * Logical Not
     */
    public function bitwise_not() : \phpseclib3\Math\BigInteger
    {
     ...
     * Logical And
     */
    public function bitwise_and(\phpseclib3\Math\BigInteger $x) : \phpseclib3\Math\BigInteger
    {
     ...
     * Logical Or
     */
    public function bitwise_or(\phpseclib3\Math\BigInteger $x) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public function bitwise_xor(\phpseclib3\Math\BigInteger $x) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public function bitwise_rightShift(int $shift) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public function bitwise_leftShift(int $shift) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public function bitwise_leftRotate(int $shift) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public function bitwise_rightRotate(int $shift) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public static function random(int $size) : \phpseclib3\Math\BigInteger
    {
        self::initialize_static_variables();
        $class = self::$mainEngine;
     ...
     * Bit length is equal to $size
     */
    public static function randomPrime(int $size) : \phpseclib3\Math\BigInteger
    {
        self::initialize_static_variables();
        $class = self::$mainEngine;
     ...
     */
    public static function randomRange(\phpseclib3\Math\BigInteger $min, \phpseclib3\Math\BigInteger $max) : \phpseclib3\Math\BigInteger
    {
        $class = self::$mainEngine;
     ...
     */
    public function root(int $n = 2) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public function pow(\phpseclib3\Math\BigInteger $n) : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public static function min(\phpseclib3\Math\BigInteger ...$nums) : \phpseclib3\Math\BigInteger
    {
        $class = self::$mainEngine;
     ...
     */
    public static function max(\phpseclib3\Math\BigInteger ...$nums) : \phpseclib3\Math\BigInteger
    {
        $class = self::$mainEngine;
        $nums = \array_map(function ($num) {
            return $num->value;
     ...
     */
    public function between(\phpseclib3\Math\BigInteger $min, \phpseclib3\Math\BigInteger $max) : bool
    {
     ...
     * Given $k, returns -$k
     */
    public function negate() : \phpseclib3\Math\BigInteger
    {
     ...
     */
    public static function scan1divide(\phpseclib3\Math\BigInteger $r) : int
    {
        $class = self::$mainEngine;
