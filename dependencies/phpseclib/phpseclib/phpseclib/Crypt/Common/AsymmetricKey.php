...
abstract class AsymmetricKey
{
     ...
     */
    public static function loadPrivateKey($key, string $password = '') : \phpseclib3\Crypt\Common\PrivateKey
    {
     ...
     * @param string|array $key
     */
    public static function loadPublicKey($key) : \phpseclib3\Crypt\Common\PublicKey
    {
        $key = self::load($key);
     ...
     * @param string|array $key
     */
    public static function loadParameters($key) : \phpseclib3\Crypt\Common\AsymmetricKey
    {
        $key = self::load($key);
     ...
     * Loads a public key
     */
    public static function loadPublicKeyFormat(string $type, string $key) : \phpseclib3\Crypt\Common\PublicKey
    {
     ...
     * @param string|array $key
     */
    public static function loadParametersFormat(string $type, $key) : \phpseclib3\Crypt\Common\AsymmetricKey
    {
        $key = self::loadFormat($type, $key);
        if (!$key instanceof \phpseclib3\Crypt\Common\PrivateKey && !$key instanceof \phpseclib3\Crypt\Common\PublicKey) {
            throw new NoKeyLoadedException('The key that was loaded was not a parameter');
     ...
     */
    public function withHash(string $hash) : \phpseclib3\Crypt\Common\AsymmetricKey
    {
        $new = clone $this;
