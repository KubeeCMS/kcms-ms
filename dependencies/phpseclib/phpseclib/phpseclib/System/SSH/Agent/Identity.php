...
class Identity implements PrivateKey
{
     ...
     */
    public function withPublicKey(PublicKey $key) : \phpseclib3\System\SSH\Agent\Identity
    {
     ...
     */
    public function withPublicKeyBlob(string $key_blob) : \phpseclib3\System\SSH\Agent\Identity
    {
        $new = clone $this;
     ...
     * Sets the hash
     */
    public function withHash(string $hash) : \phpseclib3\System\SSH\Agent\Identity
    {
        $new = clone $this;
     ...
     */
    public function withPadding(int $padding) : \phpseclib3\System\SSH\Agent\Identity
    {
        if (!$this->key instanceof RSA) {
     ...
     */
    public function withSignatureFormat(string $format) : \phpseclib3\System\SSH\Agent\Identity
    {
        if ($this->key instanceof RSA) {
