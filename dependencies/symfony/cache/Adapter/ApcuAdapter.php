...
class ApcuAdapter extends AbstractAdapter
{
    ...
    {
        return isset($namespace[0]) && \class_exists(\WP_Ultimo\Dependencies\APCUIterator::class, \false) && ('cli' !== \PHP_SAPI || \filter_var(\ini_get('apc.enable_cli'), \FILTER_VALIDATE_BOOLEAN)) ? \apcu_delete(new \WP_Ultimo\Dependencies\APCUIterator(\sprintf('/^%s/', \preg_quote($namespace, '/')), \APC_ITER_KEY)) : \apcu_clear_cache();
    }
    /**
     * {@inheritdoc}
     */
